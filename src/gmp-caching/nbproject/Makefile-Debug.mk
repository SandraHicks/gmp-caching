...
${OBJECTDIR}/_ext/5c0/master_cache_integer.o: ../master_cache_integer.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/master_cache_integer.o ../master_cache_integer.c
...
${TESTDIR}/_ext/829ac912/simpletest.o: ../tests/simpletest.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/829ac912/simpletest.o ../tests/simpletest.c
...
${OBJECTDIR}/_ext/5c0/debug_nomain.o: ${OBJECTDIR}/_ext/5c0/debug.o ../debug.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/debug_nomain.o ../debug.c;\
	else  \
...
${OBJECTDIR}/_ext/5c0/hashing_nomain.o: ${OBJECTDIR}/_ext/5c0/hashing.o ../hashing.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/hashing_nomain.o ../hashing.c;\
	else  \
...
${OBJECTDIR}/_ext/5c0/hashtable_nomain.o: ${OBJECTDIR}/_ext/5c0/hashtable.o ../hashtable.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/hashtable_nomain.o ../hashtable.c;\
	else  \
...
${OBJECTDIR}/_ext/5c0/master_cache_integer_nomain.o: ${OBJECTDIR}/_ext/5c0/master_cache_integer.o ../master_cache_integer.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/master_cache_integer_nomain.o ../master_cache_integer.c;\
	else  \
...
${OBJECTDIR}/_ext/5c0/master_cache_rational_nomain.o: ${OBJECTDIR}/_ext/5c0/master_cache_rational.o ../master_cache_rational.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/master_cache_rational_nomain.o ../master_cache_rational.c;\
	else  \
...
${OBJECTDIR}/_ext/5c0/mastercache_nomain.o: ${OBJECTDIR}/_ext/5c0/mastercache.o ../mastercache.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/mastercache_nomain.o ../mastercache.c;\
	else  \
...
${OBJECTDIR}/_ext/5c0/mpz_caching_nomain.o: ${OBJECTDIR}/_ext/5c0/mpz_caching.o ../mpz_caching.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/mpz_caching_nomain.o ../mpz_caching.c;\
	else  \
...
${OBJECTDIR}/_ext/5c0/overflow_detection_nomain.o: ${OBJECTDIR}/_ext/5c0/overflow_detection.o ../overflow_detection.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/overflow_detection_nomain.o ../overflow_detection.c;\
	else  \
